# Generated by Django 4.0.4 on 2024-01-24 00:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(default=18, on_delete=django.db.models.deletion.SET_DEFAULT, to='inventory.unit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.PositiveSmallIntegerField()),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.item')),
                ('location', models.ForeignKey(default='lab', on_delete=django.db.models.deletion.SET_DEFAULT, to='inventory.location')),
                ('unit', models.ForeignKey(default=18, on_delete=django.db.models.deletion.SET_DEFAULT, to='inventory.unit')),
            ],
            options={
